...
def design_for_pdb(args):
    ...
    log_dir = get_new_log_dir(
        os.path.join(args.out_root, "Ablation", config_name + tag_postfix + mode_postfix + mix_postfix + weight_postfix + normalize_postfix), 
        prefix=data_id
    )
...
def args_from_cmdline():
    ...
    parser.add_argument('--pdb_path', type=str, default='./data/examples/7DK2_AB_C.pdb')
