...
def main():
    ...
    parser.add_argument('-c', '--config', type=str, default='./configs/test/codesign_single_ddg_and_hydro.yml')
    ...
    parser.add_argument('--property_weight', type=float, default=0.25)
    ...
    log_dir = get_new_log_dir(os.path.join(args.out_root, config_name + tag_postfix + mode_postfix + mix_postfix + weight_postfix + normalize_postfix), prefix='%04d_%s' % (args.index, structure_['id']))
    print(log_dir)
