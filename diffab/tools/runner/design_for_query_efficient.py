...
def main():
    ...
    parser.add_argument('-c', '--config', type=str, default='./configs/test/codesign_single_hydro.yml')
    parser.add_argument('-o', '--out_root', type=str, default='./results')
    parser.add_argument('-t', '--tag', type=str, default='partial')
    parser.add_argument('--opt_type', type=str, default='BestN')
    ...
    parser.add_argument('--sample_step_num', type=int, default=5)
    ...
    log_dir = get_new_log_dir(os.path.join(args.out_root, 'query_efficient' + type_postfix, config_name + tag_postfix + mode_postfix + weight_postfix + normalize_postfix + sample_step_num_postfix), prefix='%s' % (structure_['id']))
    print(log_dir)
